...
/* this function should be used when you want to convert milliseconds to a human readable format like 4d7h */
...
/* this function helps convert a string like 7d14h to milliseconds */
export function stringToMilliseconds(text: string) {
    ...
    for (const match of matches) {
        ...
        /* get the letter that wass found */
